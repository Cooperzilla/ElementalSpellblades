...
import me.cooperzilla.elemental_spellblades.client.item.renderer.EarthOrbRenderer;
...
public class EarthOrb extends SwordItem implements GeoItem {
    ...
    public void createRenderer(Consumer<RenderProvider> consumer) {
        consumer.accept(new RenderProvider() {
            private EarthOrbRenderer renderer;

            @Override
            public BuiltinModelItemRenderer getCustomRenderer() {
                if (this.renderer == null) {
                    this.renderer = new EarthOrbRenderer();
                }
